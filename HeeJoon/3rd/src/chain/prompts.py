...
[정신과 (Psychiatry)]
- 자해·자살 직접 표현 : "죽고싶다", "자살하고 싶다", "스스로 해치고 싶다", "살 이유가 없다"
- 현실 인식 심각한 붕괴 : "없는 게 보인다", "머릿속에서 누가 말한다", "누가 나를 조종한다", "감시당하고 있다", "사라지고 싶다"
- 극심한 혼란·의사소통 불가 : "말이 전혀 안 통한다", "무슨 말을 하는지 모르겠다", "의식이 흐릿하다", "사람을 알아보지 못한다"
- 조절 불가능한 흥분·충동 : "멈출 수 없이 흥분된다", "너무 화가 나서 통제가 안 된다", "위험한 행동을 할 것 같다"
- 심각한 불안·공포 반응 : "지금 당장 죽을 것 같다", "공포 때문에 아무것도 못 하겠다"
- 틱 장애 : 반복되는 행동, 반복되는 음성
